...
<body style="background-color:black;">	
	...
	<div class="row">
		...
		<div class="container-fluid mr-1 col-sm" >
			...
			<div class="row">
				<div style="color: white;" class="col"></div>
				<div id ="submit" onclick="submit()" class="col" style="color: red; background-color:white;"><h3>SUBMIT</h3></div>&nbsp;&nbsp;&nbsp;
			...
			<div class="row">
				<div class="col"></div>
				<a class='col btn-primary' href="index.php" id="reset"><h4><strong>RESET</strong></h4></a>
				<div class="col"></div>
			</div>
		</div>	
